...
function JobSearchForm() {
  return (
    <form>
      ...
      <div style={{ display: 'flex', gap: '10px', padding: '20px', marginTop: '80px', backgroundColor: '#fff', borderRadius: '5px', boxShadow: '0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '15px' }}>
        <button style={{ border: 'none', background: 'none', color: '#4285f4', cursor: 'pointer', fontSize:'12px' }}>
          <PdfUploader />
        </button>
      </div>
